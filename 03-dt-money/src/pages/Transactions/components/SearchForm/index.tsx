...
2. Compara a versao do HTML recriada co ma versao anterior
  ...
  return (
    <SearchFormContainer onSubmit={handleSubmit(handleSearchTransactions)}>
      <input
        ...
        {...register('query')}
      />
      {/* TODO: isSubmitting vem da desestruturacao do react rook form, o truque abaix com disabled e interessante */}
